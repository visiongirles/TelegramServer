...
export const getChatsPreviewSQLRequest = `SELECT distinct on (chat_info.chat_id) messages.txt, messages.id, messages.status, messages.created_at, messages.author_id, chat_info.username, chat_info.chat_id, chat_info.photo
FROM  (
