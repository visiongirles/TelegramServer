...
--     inner join users u on c.owner_id = u.id;
 ...
 SELECT sha256('123' || salt)=password FROM users WHERE username='Kate';
 SELECT salt FROM users WHERE username='Kate';
 SELECT password FROM users WHERE username='Kate';